...
<![endif]-->
<link rel="stylesheet" type="text/css" href="backend/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="backend/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="backend/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css" href="backend/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="backend/static/h-ui.admin/css/style.css" />
<!--[if IE 6]>
...
<script type="text/javascript" src="backend/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="backend/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="backend/lib/jquery.validation/1.14.0/messages_zh.js"></script>   
<script type="text/javascript" src="backend/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="backend/lib/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="backend/lib/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="backend/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
