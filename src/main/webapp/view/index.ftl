...
<body>
            ...
            <div class="blog-main">
                ...
                <div class="home-tips shadow">
                    ...
                    <div class="home-tips-container">
                        <span style="color: red">新功能vip视频解析上线了！！！<a href="#" target="_blank" style="color:#01AAED">去围观</a></span>
                	...
                	<div class="article shadow animated fadeInLeft">
                		...
                		<div class="article-right">
                        	<div class="article-title">
                        		<a href="#"><i class="layui-icon">&#xe609;</i>终于等来了,zuoqy博客v0.1!</a>
                        	</div>
                ...
                <div class="blog-main-right">
                    ...
                    <div class="blogerinfo shadow animated fadeInRight">
                        <div class="blogerinfo-figure">
                            <img src="images/user/0.jpg" alt="Absolutely" />
                        </div>
                        <p class="blogerinfo-nickname">zuoqy</p>
                        <p class="blogerinfo-introduce">活动观赏鱼，Java开发</p>
                        <p class="blogerinfo-location"><i class="fa fa-location-arrow"></i>&nbsp;中国 - 深圳</p>
                        <hr />
					...
					<div class="blog-module shadow animated fadeInRight">
                        <div class="blog-module-title"><i class="fa fa-file-text-o"></i>&nbsp;个性签名</div>
                        <p>软件最大的好处，就是让一切变得简单。但是，做到这一点的方法，是正确设置缺省值，而不是限制用户的选择。&nbsp;&nbsp;&nbsp;--Paul Graham<p> 
                    </div>
					<!-- 广告 -->
					<div></div>
					<!-- 友情链接 -->      
                    <div class="blog-module shadow animated fadeInRight">
                        ...
                        <ul class="blogroll">
                            <li><a target="_blank" href="#" title="Layui">zuoqy博客</a></li>
                            <li><a target="_blank" href="#" title="Layui">zuoqy博客v0.1</a></li>
                        </ul>
                    </div>    
                </div>
            </div>
	...
	<script>tpwidget("init", {"flavor": "bubble","location": "WX4FBXXFKE4F","geolocation": "enabled","position": "top-right","margin": "66px 2px","language": "zh-chs","unit": "c","theme": "chameleon","uid": "UBBCD38472","hash": "d0c821f458c9fafa09ddacb76acc965c"});tpwidget("show");</script>
</body>
</html>